...
namespace MyPhotosUI
{
    public partial class MyPhotos : Form
    {
        ...
        public MyPhotos()
        {
            ...
            persons = apiController.GetAllPersons();
            events = apiController.GetAllEvents();
            newPersons = new List<Person>();
            newEvents = new List<Event>();
            places = apiController.GetAllPlaces();
            newPlaces = new List<Place>();
            landscapes = apiController.GetAllLandscapes();
        ...
        private void savePhotoButton_Click(object sender, EventArgs e)
        {
            ...
            photoToAdd.Events = newEvents;
            photoToAdd.Persons = newPersons;
            photoToAdd.Landscapes = newLandscapes;
            photoToAdd.Places = newPlaces;

            apiController.AddOrUpdatePhoto(photoToAdd);
        ...
        {
            searchedPhotos = apiController.SearchPhotoByText(searchTextBox.Text);
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            {
                apiController.DeletePhoto(searchedPhotos[currentIndex]);
                deleteButton.Visible = false;
